...
# 银行
 我初步总结了几个面试有关事项，需要考生重点准备：
1.背诵项目信息，要有自己做的内容（采用的技术语言、实现功能、遇到问题及解决思路）500字，流畅表达。
2.时刻背诵一门语言如java、python语言，各基本名词概念及区别、使用方式，掌握4000字左右文字即可；基本功要扎实，常用linux操作命令、黑盒测试、白盒测试、继承等基本概念要掌握。
3.递归函数及其用法要学习，面试和笔试都喜欢考，做上3道类似题目即可。

自我介绍，注意语速， 流畅即可
为啥来农行：老家有熟人说农行发展空间大、校招宣传说很好、农行的师兄师姐说农行好

linux常用命令，负载均衡、缓存服务器、web应用服务器、分布式数据库、分布式文件系统、CDN内容分发方式，解决高并发访问量措施等系统架构设计都要认真复习！
...
面试可能涉及到这几个问题，第一个，你为什么报这个单位，但是他大概从这三个方面进行接的第一个。家里雨洗，就说这个农行，这个简历就上面。觉得有这个发展的空间，这跟自己的兴趣爱好都是比较一致的，这个家里有些亲戚是当地的农行，这个工作比较方便，清洁，第三个有些师兄也在这些单。有些在这单位也做了一些很好的这个引导，所以抱着单位，第二个问题就是自我介绍，这么介绍就大概不要说自己的名字，把自己的以前做过些什么简单力量的说出来，大概准备个几分钟的时间吧，自我介绍一下，第三个问题就是你以前做过哪些什么项目，这些都是到底要用，大概你大概准备一下。准备一下，就是把一些做的什么项目都简单利索的，这个。发一些文字要把它。

第四个问题就是有一些逻辑题目，比如说有100张单，这个。拉一下，灭25盏灯，那你想证明什么呢，问你啦，二十五五次里面还有鸡蛋的量，可能就是这么一个。逻辑，上面这个问题就是这些第四个问题，第五个问题，就是说，这个。对当前中美贸易战啊，还有一个香港问题有什么看法，大概表达一些问题，最后一个问题，就是说，看你最后来一句，就是跟面试官说，生命不息，编码不止，他不来这份编码的工作，这句话也得说出来，总的来说的话就是要注意小孩要答题，要注意这个清晰度，一定要分123，这么陈智清要打清楚，不要说一路说来，中间没有123000万不能这么大。

中间一定要说123，比如说你拿第一个问题的时候，第一点是什么，第二个是什么，第三个车市吗，最好有分成制，一定要说123，每个问题都打出个分层次的，一点是没电了是吗，你就这么说，人家考试完才很清楚。

面试的时候淡化户口问题。

注意重点：参加哪些项目，在项目的过程中担任哪些角色。说清楚即可（大约三分钟）。

递归函数及算法，主键与索引的区别，order by与group by的区别，这一系列都是复习点
