    ...
    - 具体说说代码：
        ...
        function BagCtrl.OnBtnUse()
            ...
            S:UseItem(D.BagModel.SelectedItem.CurrentSelectedItem.ObjectConfItem.ID, D.BagModel.SelectedItem.NumUse, function (placeholder, err)
                -- 对服务器回复的物品增加消息进行处理
                --print("move to " .. placeholder)
                --print(placeholder)

                print("S:UseItem: " .. tostring(placeholder))

                --Log("BagCtrl.OnBtnUse 4 " .. tostring(D.BagModel.ResourcesItemList))
                --Log("BagCtrl.OnBtnUse 2 " .. tostring(D.BagModel.SelectedItemList.CurrentSelectedItemList))
            ...
            --Log("BagCtrl.OnBtnUse 3 " .. tostring(D.BagModel.ResourcesItemList))
            --Log("BagCtrl.OnBtnUse 1 " .. tostring(D.BagModel.SelectedItemList.CurrentSelectedItemList))
