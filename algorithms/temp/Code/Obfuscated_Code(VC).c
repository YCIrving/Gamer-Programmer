...
char* s1="第十届科技文化节";//"\u7b2c\u5341\u5c4a\u79d1\u6280\u6587\u5316\u8282";
char* s2="混乱编码大赛";//"\u6df7\u4e71\u7f16\u7801\u5927\u8d5b";
char* s3="软";//"\u8f6f";
char* s4="班";//"\u73ed";
char* s5="高宜琛";//"\u9ad8\u5b9c\u741b";
...
_%(*(">_<")-'<')?*(">_<"):putchar(10);_=_+*(">_<"+2)-';';Sleep(1000);}}

int o__o(int _)
{int OoO;int o0o;system("cls");for(OoO=0;OoO<18;OoO++){o0o=0;
    if(OoO<9){
    ...
    _=30;while(_--)putchar(32);_=20;while(_--)putchar('-');Sleep(2000);
    position(c1);putchar('A');_=10;while(_--)putchar('h');putchar('!');printf(title);Sleep(2000);position(c2);
}
int o_0(int _)
...
int o__0(int _)
{Sleep(1000);color(10);position(c3);printf("%s %s",s1,s2);
position(c4);printf("%s1309%s  %s\n",s3,s4,s5);}
